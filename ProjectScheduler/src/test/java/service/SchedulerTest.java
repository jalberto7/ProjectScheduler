...
////        scheduler.calculateSchedule(tasks);
////
////        assertEquals(LocalDate.of(2025, 1, 1).toString(), task1.getStartDate());
////        assertEquals(LocalDate.of(2025, 1, 3).toString(), task1.getEndDate());
////        assertEquals(LocalDate.of(2025, 1, 4).toString(), task2.getStartDate());
////        assertEquals(LocalDate.of(2025, 1, 7).toString(), task2.getEndDate());
////        assertEquals(LocalDate.of(2025, 1, 8).toString(), task3.getStartDate());
////    }
//}
